...
- **HistogramBuckets** — normalized bucket definitions (`+Inf` bucket is appended automatically)
- **HistogramMetric** — baked histogram definition (`MetricName` + `HistogramBuckets`) used for state observations
